...
public class ContactCreationTests {
    ...
    public void ContactCreationTests() {
        addButton();
        fillNamesData(new NamesData("First", "Mid", "Last", "Nickname"));
        fillBusinessData(new BusinessData("Address1", "Company", "Title"));
        fillPhonesData(new PhonesData("123456", "1234567", "12345678", "123456789"));
        fillEmailsData(new EmailsData("test@test.ru", "test2@test.ru", "test3@test.ru"));
        fillOtherData(new OtherData("http://ya.ru", "Address2", "Home", "Note"));
        confirmation();
        backHomePage();
    }
    ...
    private void fillOtherData(OtherData otherData) {
    ...
    private void fillEmailsData(EmailsData emailsData) {
    ...
    private void fillPhonesData(PhonesData phonesData) {
    ...
    private void fillBusinessData(BusinessData businessData) {
    ...
    private void fillNamesData(NamesData namesData) {
